...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1729919350403908&ev=PageView&noscript=1" /></noscript>
            ...
            <form class="contact__form" method="POST" action="contact3.php" name="contact-form">
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner  contact-item__inner_name">
                        ...
                        <div class="contact-item__field-area">
                            ...
                            <input class="contact-item__field validate[required]" id="name-last" type="text"
                                name="name-last" placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <label for="name-first">名</label>
                            <input class="contact-item__field validate[condRequired[name-last]]" id="name-first"
                                type="text" name="name-first" placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner  contact-item__inner_name">
                        ...
                        <div class="contact-item__field-area">
                            ...
                            <input class="contact-item__field validate[required]" id="name-last-kana" type="text"
                                name="name-last-kana" placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <label for="name-first-kana">名</label>
                            <input class="contact-item__field validate[condRequired[name-last-kana]]"
                                id="name-first-kana" type="text" name="name-first-kana" placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                    <!-- Contact item fields - END -->
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner">
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <input class="contact-item__field" id="school-year" type="text" name="school-year"
                                placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner">
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <input class="contact-item__field validate[required, custom[phone]]" id="phone-number"
                                type="tel" name="phone-number" placeholder="">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                    <!-- Contact item fields - END -->
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner">
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <input class="contact-item__field validate[required, custom[email]]" id="email" type="email"
                                name="email" placeholder="sample@example.com">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                    <!-- Contact item fields - END -->
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner  contact-item__inner_wrap">
                        ...
                        <div class="contact-item__field-area">
                            <input class="contact-item__field validate[required, custom[email],equals[email]]"
                                id="email-check" type="email" name="email-check" placeholder="sample@example.com">
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                    <!-- Contact item fields - END -->
                ...
                <div class="contact__item  contact-item">
                    ...
                    <div class="contact-item__inner">
                        <!-- Contact item field - START -->
                        <div class="contact-item__field-area">
                            <textarea class="contact-item__field  contact-item__field_textarea" id="questions"
                                name="questions" cols="30" rows="8" placeholder="ご質問・ご要望等がございましたらお書きください。"></textarea>
                        </div>
                        <!-- Contact item field - END -->
                    </div>
                    <!-- Contact item fields - END -->
